AWSBedrockLlama2Stream is a deprecated utility function that transforms AWS Bedrock API outputs into a ReadableStream. It has been removed in AI SDK 4.0 and is part of the legacy AWS Bedrock integration that is incompatible with AI SDK 3.1 functions.
