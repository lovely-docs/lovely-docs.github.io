**DEPRECATED**: AWSBedrockCohereStream has been removed in AI SDK 4.0 and is part of the legacy AWS Bedrock integration, incompatible with AI SDK 3.1 functions.

**Purpose**: Transform AWS Bedrock API outputs into a ReadableStream, using AIStream under the hood to handle Bedrock response parsing.
...
`AWSBedrockCohereStream(response, callbacks)` → `ReadableStream`
