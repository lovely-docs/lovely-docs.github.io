...
async function startHttpServer(
  ...
  app.post("/mcp", async (req: Request, res: Response) => {
    ...
    const filterOptions: LibraryFilterOptions = {
      includeLibs: [
        ...(defaultFilterOptions.includeLibs || []),
        ...(queryFilters.includeLibs || []),
      ],
      includeEcosystems: [
        ...(defaultFilterOptions.includeEcosystems || []),
        ...(queryFilters.includeEcosystems || []),
      ],
      excludeLibs: [
        ...(defaultFilterOptions.excludeLibs || []),
        ...(queryFilters.excludeLibs || []),
      ],
      excludeEcosystems: [
        ...(defaultFilterOptions.excludeEcosystems || []),
        ...(queryFilters.excludeEcosystems || []),
      ],
    };
  ...
  app
    .listen(port, () => {
      console.error(
        `Lovely Docs MCP HTTP server running on http://localhost:${port}/mcp`
      );
