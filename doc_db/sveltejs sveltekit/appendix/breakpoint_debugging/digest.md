...
**Visual Studio Code**
- Debug Terminal: Open command palette (CMD/Ctrl + Shift + P), launch "Debug: JavaScript Debug Terminal", start your project (e.g., `npm run dev`), set breakpoints, trigger them.
...
3. Open browser DevTools and click "Open dedicated DevTools for Node.js" icon
