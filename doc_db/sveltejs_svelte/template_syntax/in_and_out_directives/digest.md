...
The element flies in with the `fly` transition and fades out with the `fade` transition. Both transitions can play simultaneously without reversing each other.