...
var doc_cache_js_1 = require("./lib/doc-cache.js");
var doc_db_path = (0, path_1.join)(process.cwd(), '..', 'doc_db');
await (0, doc_cache_js_1.loadLibrariesFromJson)(doc_db_path);
...
server.setRequestHandler(types_js_1.CallToolRequestSchema, function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, args, message;
    return __generator(this, function (_b) {
        _a = request.params, name = _a.name, args = _a.arguments;
        switch (name) {
            case "example_tool": {
                message = args === null || args === void 0 ? void 0 : args.message;
                return [2 /*return*/, {
                        content: [
                            {
                                type: "text",
