...
A set of mutually exclusive radio buttons where only one option can be selected at a time.
...
- `RadioGroup.Root` - Container component with `value` prop for controlled state
